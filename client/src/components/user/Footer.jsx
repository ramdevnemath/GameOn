                        ...
                        <ul>
                            <li className="mb-4">
                                <Link to={""} target="_blank"
                                    className="text-gray-600 hover:underline dark:text-gray-400">support@gameon.com</Link>
                            </li>
                            <li>
                                <Link to={""} target="_blank" rel="nofollow"
                                    className="text-gray-600 hover:underline dark:text-gray-400">+91 96332 19506</Link>
                            </li>
                        </ul>
                    </div>
                    <div>
                        ...
                        <ul>
                            <li className="mb-4">
                                <Link to={""} target="_blank"
                                    className="text-gray-600 hover:underline dark:text-gray-400">Brototype</Link>
                            </li>
                            <li>
                                <Link to={""} target="_blank" rel="nofollow"
                                    className="text-gray-600 hover:underline dark:text-gray-400">Kochi, India</Link>
                            </li>
                        </ul>
                    </div>
                    <div>
