            ...
            if (formMode === 'Add') {
                if (imageUpload && imageUpload.length > 0) {
                    if (imageUpload.length === 1) {
                        ...
                        await vendorInstance.post('/post-turf-details', {
                            vendor,
                            tags,
                            turfName,
                            description,
...
useEffect(() => {
    if (formMode === 'Update' && addedTurfDetails) {
        setTurfName(addedTurfDetails.turfName);
        setDescription(addedTurfDetails.description);
        setLocation(addedTurfDetails.location);
        setCity(addedTurfDetails.city);
    }
}, [formMode, addedTurfDetails]);
